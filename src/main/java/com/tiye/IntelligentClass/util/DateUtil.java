...
public class DateUtil {
    ...
    public static String getAfterDayDate(String startDay,Integer days) {
        int daysInt = days.intValue();
        Date startDate=fomatDate(startDay,DateUtil.sdfDay);
        Calendar canlendar = Calendar.getInstance();
        canlendar.setTime(startDate);
        canlendar.add(canlendar.DATE, daysInt); // 日期减如果不够减会将月变动
        Date date = canlendar.getTime();
